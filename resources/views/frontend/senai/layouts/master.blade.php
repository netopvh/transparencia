            ...
            <div class="container">
                ...
                <section class="col-md-3 col-xs-12 col-b b-12">
                    <div class="title">
                        <div class="al-ta ">
                            ...
                            <div><span><strong><a href="{{ route('senai.sac') }}">
                ...
                <section class="col-md-3 col-xs-6 col-c">
                    <div class="al-ta ">
                        ...
                        <div>
                            <h4 class="title b-15"><strong>Sede SENAI Rondônia</strong></h4>
...
<script type="text/javascript" src="{{ asset('frontend/senai/assets/js/vendors.min.js') }}"></script>
<script type="text/javascript" src="{{ asset('frontend/senai/assets/js/scripts.min.js') }}"></script>
<script type="text/javascript">var switchTo5x = true;</script>
<script type="text/javascript" src="{{ asset('frontend/senai/assets/js/buttons.min.js') }}"></script>
...
<script src="{{ asset('frontend/senai/assets/js/anmap.js') }}" type="text/javascript"></script>
<script src="{{ asset('frontend/senai/assets/js/brazilLow.js') }}" type="text/javascript"></script>
</body>
