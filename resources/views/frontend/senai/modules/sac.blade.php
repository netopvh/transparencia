...
@section('content')
    <div class="row">
        <div class="col-xs-12">
            O <b>Serviço Nacional de Aprendizagem Industrial (SENAI)</b> é reconhecido como modelo de educação profissional e pela qualidade dos
            serviços tecnológicos que promovem a inovação na indústria brasileira. Desde que foi criado, em 1942, o SENAI formou mais de
