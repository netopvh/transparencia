...
@section('content')
    <div class="menu-estrutura">
        ...
        <p>• <a href="{{ route('senai.execucao') }}">Execução Orçamentária {{ date('Y') }}</a></p>
        ...
        <p>• <a href="{{ route('senai.remunera') }}" target="_self">Estrutura Remuneratória</a></p>

        <p>• <a href="{{ route('senai.dirigentes') }}" target="_self">Relação de Dirigentes</a></p>

        <p>• <a href="{{ route('senai.tecnicos') }}" target="_self">Relação dos Membros do Corpo Técnico</a></p>
