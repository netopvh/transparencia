            ...
            <div class="col-lg-6">
                <div class="panel panel-flat">
                    <div class="panel-heading">
                        <h5 class="panel-title">Editar FAQ</h5>
                    ...
                    <div class="panel-body">
                        <form action="{{ route('admin.faq.update',['id' => $faq->id]) }}" class="form-validate" method="post"
                              autocomplete="off">
                        {{ csrf_field() }}
                        <!-- Inicio do Form -->
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="casa_id" autofocus required>
                                            ...
                                            @foreach($casas as $casa)
                                                <option value="{{ $casa->id }}"{{ $casa->id==$faq->casa->id?" selected":"" }}>{{ $casa->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
