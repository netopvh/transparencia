...
@section('scripts-after')
    ...
    <script type="text/javascript" src="{{ asset('backend/assets/js/modules/pagina.js') }}"></script>
            ...
            <div class="col-lg-10">
                <div class="panel panel-flat">
                    <div class="panel-heading">
                        <h5 class="panel-title">Criar Nova Página</h5>
                            ...
                            <form action="{{ route('admin.paginas.dinamica.store') }}" method="post">
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        <div class="form-group">
                                            <label>Conteúdo:
                                                <textarea id="summernote" name="script" rows="18"></textarea>
                                            </label>
                                        </div>
                                    </div>
                                </div>
